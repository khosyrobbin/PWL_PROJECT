<ul class="sidebar-menu" data-widget="tree">
    ...
    <li class="{{request()->is('trasaksi')?'active': ''}}"><a href="/trasaksi"><i class="fa fa-book"></i> <span>Data Transaksi</span></a></li>
    <li class="{{request()->is('pembayaran')?'active': ''}}"><a href="/pembayaran"><i class="fa fa-calendar"></i> <span>Data Pembayaran</span></a></li>
    <li class="{{request()->is('pemebeli')?'active': ''}}"><a href="/pemebeli"><i class="fa fa-clipboard"></i> <span>Data Pembeli</span></a></li>
</ul>
